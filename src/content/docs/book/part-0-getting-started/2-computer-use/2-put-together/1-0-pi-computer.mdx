...
export const Swiper1 = [
  {
    ...
    altText: "Image showing raspberry Pi in it's case with 4 screws and a screwdriver",
    tipHeader: "Make sure the ports are aligned",
    tips: []
  },
  {
    src: Swiper1Slide2.src,
    altText: "Image showing the side of the pi with USB-C and HDMI ports aligned correctly",
    tips: []
  },
  {
    src: Swiper1Slide3.src,
    altText: "Image showing the side of the pi with LAN and USB ports aligned correctly",
    tips: []
  },
  {
...
export const Swiper3 = [
  {
    ...
    altText: "Image showing the VESA mount and the case sitting on top of the monitor with the nylon screws and spacers",
    tips: []
  },
  {
  ...
  },
  {
    ...
    altText: "Image showing the VESA mount installed on the case close up, showing how the screws and spaces are installed",
    tips: []
  }
];
...
export const Swiper4 = [
  {
    ...
    altText: "Image Wide Shot showing the USB-C and HDMI cables connected to the Pi and the screen",
    tips: []
  },
  {
    src: Swiper4Slide2.src,
    altText: "Image Showing the Micro HDMi connected to the first port on the Pi",
    tips: []
  },
  {
...
export const Swiper5 = [
  ...
  },
  {
    ...
    altText: "Image showing the side of the stand right with the VESA mount just inside of the stand",
    tips: []
  },
  {
    src: Swiper5Slide3.src,
    altText: "Image showing the side of the stand left with the VESA mount just inside of the stand",
    tips: []
  }
];
...
export const Swiper6 = [
  ...
  },
  {
    ...
    altText: "Close up image showing the keyboards USB cable connected to the Pi",
    tips: []
  }
];
...
export const Swiper8 = [
  ...
  },
  {
    ...
    altText: "Image with the Pi folded down shwoing the Pi connected to the battery bank",
    tips: []
  }
];
