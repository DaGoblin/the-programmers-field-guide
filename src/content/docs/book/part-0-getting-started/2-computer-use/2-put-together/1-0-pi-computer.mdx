...
import Slide1 from './images/Pi-Computer/Swiper1/Slide1.png';
import Slide2 from './images/Pi-Computer/Swiper1/Slide2.png';
...
export const swiper1 = [
  {
    ...
    tipStart: 1,
    tips: [
      "Use the screws to secure the Pi to the case"
    ]
  },
  {
    src: Slide2.src,
    ...
    tipStart: 3,
    tips: [
      "Ensure the USB-C and HDMI ports are aligned correctly"
    ]
  }
]; -->
